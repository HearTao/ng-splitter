import { startsWith, removeSuffix, find, some, equateStringsCaseSensitive, identity, equateStringsCaseInsensitive, lastOrUndefined, endsWith, firstDefined } from "../utils";
import { CharacterCodes, Ending, GetCanonicalFileName } from "./types";
import { CompilerOptions, Extension, JsxEmit, ModuleKind, ModuleResolutionKind, ScriptTarget } from "typescript";
...
export function removeExtensionAndIndexPostFix(fileName: string, ending: Ending, options: CompilerOptions): string {
...
export function getJSExtensionForFile(fileName: string, options: CompilerOptions): Extension {
...
export function getRelativePathIfInDirectory(path: string, directoryPath: string, getCanonicalFileName: GetCanonicalFileName): string | undefined {
...
export function getPathRelativeToRootDirs(path: string, rootDirs: readonly string[], getCanonicalFileName: GetCanonicalFileName): string | undefined {
